...
const FName ACarProjectPawn::LookUpBinding("LookUp");
const FName ACarProjectPawn::LookRightBinding("LookRight");
const FName ACarProjectPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

ACarProjectPawn::ACarProjectPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UCarProjectWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UCarProjectWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UCarProjectWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UCarProjectWheelRear::StaticClass();
...
void ACarProjectPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ACarProjectPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ACarProjectPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ACarProjectPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ACarProjectPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACarProjectPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACarProjectPawn::OnResetVR); 
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ACarProjectPawn::Fire);
}

void ACarProjectPawn::Fire()
{
	...
	if (ProjectileClass)
	{
		...
		//FRotator Rotation(Camera->componentToWorld.GetRotation());
		...
		if (World)
		{
			...
			AAProjectile* Projectile = World->SpawnActor<AAProjectile>(ProjectileClass, MuzzleLocation, MuzzleRotation, SpawnParams);
			if (Projectile)
			{
...
void ACarProjectPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ACarProjectPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ACarProjectPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ACarProjectPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ACarProjectPawn::EnableIncarView(const bool bState)
{
...
void ACarProjectPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ACarProjectPawn::BeginPlay()
{
	Super::BeginPlay();
...
void ACarProjectPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ACarProjectPawn::UpdateHUDStrings()
{
...
void ACarProjectPawn::SetupInCarHUD()
{
...
void ACarProjectPawn::UpdatePhysicsMaterial()
{
